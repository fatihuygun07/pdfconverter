...
public partial class CompressPage : Page
{
    ...
    private void Compress_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (saveDialog.ShowDialog() == true)
        {
            try
            {
                PdfHelper.CompressPdf(selectedFile, saveDialog.FileName);
                MessageBox.Show("PDF başarıyla sıkıştırıldı!", "Başarılı", MessageBoxButton.OK, MessageBoxImage.Information);
                selectedFile = null;
